...
```powershell
codex mcp add binance-research-pro -- npx -y --package=@steveyangpi/binance-research-pro-mcp@1.0.0 -- binance-research-pro-mcp
claude mcp add --scope local binance-research-pro -- npx -y --package=@steveyangpi/binance-research-pro-mcp@1.0.0 -- binance-research-pro-mcp
```
...
command = "npx"
args = ["-y", "--package=@steveyangpi/binance-research-pro-mcp@1.0.0", "--", "binance-research-pro-mcp"]
